...
\begin{itemize}
	\item \textbf{Your vote is encrypted before it is stored in the database}. It is never stored in plaintext. Not even the election administrator or AmarVote staff can see how you voted.
...
\begin{enumerate}
	...
	\item A profile menu will appear. Click \uibutton{Turn On} Two-Step Verification.
	...
	\item Click \uibutton{Confirm and Enable}. 2FA is now active on your account.
\end{enumerate}
...
\begin{tcolorbox}[notebox]
	...
	\end{itemize}
	If any of these conditions are not met, the Voting Booth will not be available to you.
\end{tcolorbox}
...
\begin{itemize}
	\item \uibutton{Challenge Vote (Benaloh Challenge)} --- to verify the encryption is correct.
	\item \uibutton{Cast Vote} --- to submit your vote permanently.
\end{itemize}
...
\begin{enumerate}
	\item Click \uibutton{Challenge Vote (Benaloh Challenge)}.
	...
	\item Click \uibutton{Challenge Ballot}.
...
\begin{enumerate}
	...
	\item You will see two buttons: \uibutton{Challenge Vote (Benaloh Challenge)} and \uibutton{Cast Vote}.
	\item Click \uibutton{Cast Vote}.
\end{enumerate}

\screenfig{castEncryptedBallot.png}{Clicking \textit{Cast Vote} to submit your vote permanently}

\begin{tcolorbox}[dangerbox]
	\textbf{This action is permanent and irreversible.} Once you click \uibutton{Cast Vote}, your vote is submitted to the system and \textbf{cannot be changed, recalled, or re-cast}. Make absolutely sure you have selected the right candidate(s) before casting.
\end{tcolorbox}
...
This means your vote was counted exactly as you cast it. 
...
\begin{enumerate}
	...
	\item \textbf{Enable 2FA} --- After logging in, click your profile avatar, click \uibutton{Turn on} Two-Step Verification, scan the QR code with your authenticator app, and confirm.
\end{enumerate}
...
\begin{enumerate}
	...
	\item \textbf{Optionally Verify (Benaloh Challenge)} --- Click \uibutton{Challenge Vote}, re-select the same candidate(s), click \uibutton{Submit Challenge}, and check the result. The challenged ballot is discarded. Repeat steps 4--5 as many times as you like.
	\item \textbf{Cast Your Vote} --- When ready, click \uibutton{Cast Vote}. This is permanent and irreversible.
...
\begin{center}
	\begin{tabularx}{0.95\textwidth}{>{\bfseries}l X}
		...
		\midrule
		\rowcolor{lightgray}Vote Privacy & Your vote is encrypted before being stored in the database, so that later no one --- not the admin, not the server --- can record how you voted.\\
