...
\begin{enumerate}
	...
	\item Navigate to the election's \uimenu{Guardian} tab.
	\item You will see the \textbf{Phase 3: Schedule Election \& Notifications} panel is now active.
\end{enumerate}
...
The scheduling interface features a \textbf{modern, interactive date-and-time picker} designed for ease and precision:
