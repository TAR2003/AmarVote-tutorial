...
\begin{enumerate}
	...
	\item Check your email for a password reset link (valid for some minutes).
...
\begin{tcolorbox}[warnbox]
	Your password and decrypted private key are used only in-memory during this step. They are \textbf{never stored} in the database. The database only stores the encrypted backup shares.
\end{tcolorbox}
